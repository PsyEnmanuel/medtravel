<template>
    <q-page :class="!$isDesktop ? 'px-1.5 py-2' : insuredId ? 'px-2 py-3' : 'px-1.5 py-2 lg:px-5 lg:py-6'">
        ...
        <div class="flex lg:flex-nowrap w-full gap-2">
            <InsuranceSelect class="mb-2 lg:w-[250px] w-full" @setInsurance="setInsurance"
                ...
                <div class="q-py-xs col-xs-12 col-sm-6 col-md-4"
                    ...
                    <div bordered flat class="card pb-2 relative flex flex-nowrap">
                        ...
                        <div class="pl-3 pr-8 w-full pt-2 flex flex-col overflow-hidden">
                            <span class="text-uppercase line-clamp-1 font-semibold text-xs">{{
                                props.row.customer_description }}</span>
                            <span class="text-uppercase line-clamp-1 font-semibold text-xs">{{ props.row.policy_number
                                }}</span>
                            <span class="text-uppercase line-clamp-1 font-semibold text-xs">{{ props.row.insurance
                                }}</span>
                            <span class="text-uppercase line-clamp-1 font-semibold text-xs">{{ props.row.policy_branch
                                }}</span>
                            <span class="text-uppercase line-clamp-1 font-semibold text-xs">{{ props.row.policy_type
                                }}</span>
...
import PolicyWrite from './components/PolicyWrite.vue'
...
const state = reactive({
    ...
    selected: [],
    search: '',
    search_key: 'orlike:insurance,policy_number',
    pagination: {
