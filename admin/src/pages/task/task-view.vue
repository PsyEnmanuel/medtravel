                ...
                <q-tab-panels v-if="!state.loading" v-model="state.tab" class="bg-transparent">
                    <q-tab-panel name="edit" class="p-0">
                        <div class="card px-3 py-2">
                            <TaskWrite isEdit :id="state.item.id" width="100%" />
                        </div>
                    </q-tab-panel>
                </q-tab-panels>
            </div>
...
import TaskWrite from './components/TaskWrite.vue'
...
const state = reactive({
    ...
    timeout: null,
    tabs: [
        { label: 'Editar Solicitud', value: 'edit', icon: 'fa-duotone fa-solid fa-user-pen', visible: 1 },
    ],
    tab: 'edit',
    tabList: 'history',
    item: {},
